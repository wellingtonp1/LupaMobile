...
<ScrollView style={Sharestyle.descriptionView}>
    <Text style={Sharestyle.pageTitleBlue}>Falta de asfalto</Text>
    <Text style={Sharestyle.descriptionTitle}>Aponte problemas com a vias públicas</Text>

      <ModalItem>
      <Text style={Sharestyle.descriptionSubTitle}> A via é parcialmente asfaltada ?</Text>
            <ModalInfo>
               <ModalPrevArea>
                    <NavPrevIcon width="35" height="35" fill="#000000" />
               </ModalPrevArea>
               <ModalTitleArea>
                    <ModalTitle>Não há asfalto</ModalTitle>
               </ModalTitleArea>
               <ModalNextArea>
          ...
          <Text style={Sharestyle.descriptionSubTitle}> Presença de crateras ou buracos ?</Text>
            <ModalInfo>
               <ModalPrevArea>
                    <NavPrevIcon width="35" height="35" fill="#000000" />
               </ModalPrevArea>
